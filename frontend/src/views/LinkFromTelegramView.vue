...
<template>
  <div class="page">
    <header class="head">
      ...
      <p class="sub">
        Укажите email и пароль. Если этого email ещё нет на сайте — будет создан вход с этим паролем
        (не короче 8 символов). Если аккаунт с таким email уже есть —
        укажите <strong class="semi">текущий пароль от сайта</strong>:
        ваш Telegram будет объединён с этим аккаунтом (трафик и срок подписки сохранятся там, где
        выгоднее; дубликат из бота удалится).
      </p>
    </header>
