...
class Server(Base):
    ...
    provision_step: Mapped[str | None] = mapped_column(Text, nullable=True)
    provision_progress: Mapped[int] = mapped_column(Integer, nullable=False, default=0)
    provision_detail: Mapped[str | None] = mapped_column(Text, nullable=True)
